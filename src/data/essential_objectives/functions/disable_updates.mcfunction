...
execute if score #eo_DummyPlayer eo_EnTools matches 1 run function essential_objectives:tools/disable_updates
execute if score #eo_DummyPlayer eo_EnMisc matches 1 run function essential_objectives:misc/disable_updates
